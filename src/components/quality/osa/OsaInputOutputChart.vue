...
export default {
  ...
  methods: {
    ...
    get_data () {
      ...
      if (this.timevalue !== null) {
        ...
        that.$axios({
          method: 'get',
          url: '/display/product-statistic-query/osa-input-and-output-summary-by-production-series-and-date',
          params: {
            startTime: start,
            endTime: end
          },
    ...
    get_chart () {
      ...
      var input = 0
      for (let x = 0; x < series[2]['data'].length; x++) {
        input = input + series[2]['data'][x]['y']
      }
      // console.log(input)
      var out = 0
      ...
      // console.log(out)
      var subtitleText = '(' + series[2]['name'] + '——投入:' + String(input) + '  ' + series[7]['name'] + '——通过:' + String(out) + ')'
  ...
  data () {
    return {
      ...
      rotationC: 0,
      id1: 'high1',
      process_sort: ['TC1_IN', 'TC1_OUT', 'TC0_1G', 'TC0_10G', 'TC2_IN', 'TC2_OUT', 'TC1', 'FQC_OSA'],
      calendarAllData: [],
      chartdata: [],
      cardData: [],
      calendarData: [],
...
.OsaInputOutputChart >>> .el-calendar-table .el-calendar-day {
  height: 50px;
}
.is-selected {
  color: #f35858;
