...
export default {
  ...
  methods: {
    ...
    get_pn () {
      ...
      that.loading = true
      that.$axios({
        url: '/display/product-operation-info/osa/overview/all-osa-info-today',
        method: 'get'
...
.OsaBigUpBoard >>> .el-table thead {
    color: white !important;
}
.OsaBigUpBoard >>> .el-table th, .el-table tr{
    background-color: rgb(84, 92, 100) !important;
}
.OsaBigUpBoard >>>.el-table td, .el-table th.is-leaf {
  padding: 0;
  background-color: rgb(84, 92, 100) !important;
