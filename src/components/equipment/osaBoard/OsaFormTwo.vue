<template>
<div class="OsaFormTwo" style="background-color: #ffffff;">
  <download-excel
...
.OsaFormTwo >>> .el-table thead {
    color: white !important;
}
.OsaFormTwo >>> .el-table th, .el-table tr{
    background-color: rgb(84, 92, 100) !important;
}
.OsaFormTwo >>>.el-table td, .el-table th.is-leaf {
  background-color: rgb(84, 92, 100) !important;
  border-bottom-width: 0px !important;
  color: white;
}
.OsaFormTwo >>> .el-pagination__total {
  color: white !important;
}
</style>
