<template>
<div class="OsaBigFormFour" style="background-color: #ffffff;height: 955px">
  <!-- <download-excel
...
.OsaBigFormFour >>> .el-table thead {
    color: white !important;
}
.OsaBigFormFour >>> .el-table th, .el-table tr{
    background-color: rgb(84, 92, 100) !important;
}
.OsaBigFormFour >>>.el-table td, .el-table th.is-leaf {
  background-color: rgb(84, 92, 100) !important;
  border-bottom-width: 0px !important;
  color: white;
}
.OsaBigFormFour >>> .el-pagination__total {
  color: white !important;
}
</style>
